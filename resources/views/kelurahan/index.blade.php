    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="nav-item">
                                <a href=" {{route('kelurahan.create')}} " class="nav-link">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="{{route ('kelurahan.store')}}">
                    <div class="row">
                        <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route ('kelurahan.destroy', $data->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{route('kelurahan.show', $data->id)}}" class=" btn btn-outline-success ">Lihat</a>
                                            <a href="{{route('kelurahan.edit', $data->id)}}" class=" btn btn-outline-info ">Edit</a>
