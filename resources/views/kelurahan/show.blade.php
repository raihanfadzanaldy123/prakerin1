                    ...
                    <div class="card-body">
                        <form action="{{ route('kelurahan.index')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_kelurahan" value="{{ $kelurahan->nama_kelurahan }}" readonly id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Kode Provinsi">
                            </div>
                            <div class="form-group">
