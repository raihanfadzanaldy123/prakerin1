                ...
                <div class="row mb-2">
                    ...
                    <!-- <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="nav-item">
                                <a href=" {{route('kota.create')}} " class="nav-link">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route ('kota.destroy', $data->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{route('kota.show', $data->id)}}" class=" btn btn-outline-success ">Lihat</a>
                                            <a href="{{route('kota.edit', $data->id)}}" class=" btn btn-outline-info ">Edit</a>
